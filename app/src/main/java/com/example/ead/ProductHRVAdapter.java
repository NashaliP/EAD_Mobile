...
//
//public class ProductHRVAdapter extends RecyclerView.Adapter<ProductHRVAdapter.MyViewHolder> {
//    Context context;
//    ArrayList<ProductModel> productModelsArraylist;
//
//    public ProductHRVAdapter(Context context, ArrayList<ProductModel> productModelsArraylist) {
...
//    @NonNull
//    @Override
//    public ProductHRVAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(context).inflate(R.layout.product_hcard, parent, false);
//        return new MyViewHolder(view);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull ProductHRVAdapter.MyViewHolder holder, int position) {
...
//            super(itemView);
//            prName = itemView.findViewById(R.id.etvHProductName);
//            prPrice = itemView.findViewById(R.id.etvHProductPrice);
////            prEditBtn = itemView.findViewById(R.id.idEditBtn2);
//            prImage = itemView.findViewById(R.id.idIBHProduct);
